...
-- adoption_stage / adoption_stage_rationale は migrations/017_theme_ecosystem_adoption_stage.sql 適用後に有効
INSERT OR REPLACE INTO theme_ecosystem_members
...
VALUES
  ('eco-edo-5022', 'theme-seed-edo-circular', '5022', 'レボインターナショナル', 'エネルギー還流', '現代の下肥商', 0, '2026-02-28', '地政学ポテンシャル: 廃食用油回収の分散型ネットワークとSAF化', NULL, NULL),
  ('eco-edo-5020', 'theme-seed-edo-circular', '5020', 'ＥＮＥＯＳホールディングス', 'エネルギー還流', '大江戸エネルギー大問屋', 0, '2026-02-28', '地政学ポテンシャル: 廃プラ油化・SAF等、巨大還流ハブへの転換', NULL, NULL),
  ('eco-edo-5019', 'theme-seed-edo-circular', '5019', '出光興産', 'エネルギー還流', '地域エネルギーの元締', 0, '2026-02-28', '地政学ポテンシャル: アンモニア・水素の地域グリッド構築', NULL, NULL),
  ('eco-edo-5011', 'theme-seed-edo-circular', '5011', 'ニチレキグループ', 'エネルギー還流', '現代の普請', 0, '2026-02-28', '地政学ポテンシャル: アスファルト再生による道路インフラの長寿命化', NULL, NULL),
  ('eco-edo-5013', 'theme-seed-edo-circular', '5013', 'ユシロ化学工業', 'エネルギー還流', '道具の守り人', 0, '2026-02-28', '地政学ポテンシャル: 生分解性切削油による低エントロピー加工', NULL, NULL),
  ('eco-edo-5018', 'theme-seed-edo-circular', '5018', 'ＭＯＲＥＳＣＯ', 'エネルギー還流', '職人御用達の油さし', 0, '2026-02-28', '地政学ポテンシャル: 環境負荷極小の特殊真空ポンプ油等', NULL, NULL),
  ('eco-edo-5021', 'theme-seed-edo-circular', '5021', 'コスモエネルギーホールディングス', 'エネルギー還流', '風の文明への先導者', 0, '2026-02-28', '地政学ポテンシャル: 風力発電とSAFへのポートフォリオ移行', NULL, NULL),
  ('eco-edo-3315', 'theme-seed-edo-circular', '3315', '日本コークス工業', 'エネルギー還流', '現代の炭焼き', 0, '2026-02-28', '地政学ポテンシャル: 石炭技術の資源リサイクル・粉体技術への転用', NULL, NULL),
  ('eco-edo-5010', 'theme-seed-edo-circular', '5010', '日本精蝋', 'エネルギー還流', '現代の蝋燭屋', 0, '2026-02-28', '地政学ポテンシャル: 天然由来ワックス・高機能素材による脱石油', NULL, NULL),
  ('eco-edo-5017', 'theme-seed-edo-circular', '5017', '富士石油', 'エネルギー還流', '循環型リファイナリー', 0, '2026-02-28', '地政学ポテンシャル: 原油精製拠点のバイオ燃料化プロセス', NULL, NULL),
  ('eco-edo-5015', 'theme-seed-edo-circular', '5015', 'ビーピー・カストロール', 'エネルギー還流', '摩擦の制御師', 0, '2026-02-28', '地政学ポテンシャル: 高効率潤滑による機械寿命の最大化', NULL, NULL),

  ('eco-edo-3861', 'theme-seed-edo-circular', '3861', '王子ホールディングス', '素材還流', '大江戸八百八町の森番', 0, '2026-02-28', '地政学ポテンシャル: 広大な社有林による炭素固定と木材由来新素材CNFの社会実装', NULL, NULL),
  ('eco-edo-3863', 'theme-seed-edo-circular', '3863', '日本製紙', '素材還流', '令和の和紙革新師', 0, '2026-02-28', '地政学ポテンシャル: 脱プラを加速させる紙製バリア包装とCNFの多用途展開', NULL, NULL),
  ('eco-edo-3941', 'theme-seed-edo-circular', '3941', 'レンゴー', '素材還流', '還流の総元締', 0, '2026-02-28', '地政学ポテンシャル: 段ボールリサイクル率99%以上を支える循環インフラ', NULL, NULL),
  ('eco-edo-3877', 'theme-seed-edo-circular', '3877', '中越パルプ工業', '素材還流', '里山資源の再生屋', 0, '2026-02-28', '地政学ポテンシャル: 放置竹林を紙に変える竹紙プロジェクト', NULL, NULL),
  ('eco-edo-3708', 'theme-seed-edo-circular', '3708', '特種東海製紙', '素材還流', '高機能紙の細工師', 0, '2026-02-28', '地政学ポテンシャル: 特殊紙技術と廃棄物焼却による自家発電循環', NULL, NULL),
  ('eco-edo-3891', 'theme-seed-edo-circular', '3891', 'ニッポン高度紙工業', '素材還流', '電気の還流を支える薄紙師', 0, '2026-02-28', '地政学ポテンシャル: コンデンサ用セパレータ世界首位でエネルギー循環を支える', NULL, NULL),
  ('eco-edo-3896', 'theme-seed-edo-circular', '3896', '阿波製紙', '素材還流', '水と繊維の調律師', 0, '2026-02-28', '地政学ポテンシャル: 水処理膜用支持体など環境浄化ネットワークの中核', NULL, NULL),
  ('eco-edo-3950', 'theme-seed-edo-circular', '3950', 'ザ・パック', '素材還流', '現代の通い袋師', 0, '2026-02-28', '地政学ポテンシャル: プラスチックから紙へのシフトを店頭から支える', NULL, NULL),
  ('eco-edo-3864', 'theme-seed-edo-circular', '3864', '三菱製紙', '素材還流', '情報の定着師', 0, '2026-02-28', '地政学ポテンシャル: リサイクル可能な感熱紙と環境配慮素材への転換', NULL, NULL),

  ('eco-edo-4540', 'theme-seed-edo-circular', '4540', 'ツムラ', '生命還流', '現代の薬草園・漢方の守り人', 0, '2026-02-28', '地政学ポテンシャル: 生薬の持続可能な調達ネットワークと未病・養生の知恵', NULL, NULL),
  ('eco-edo-4527', 'theme-seed-edo-circular', '4527', 'ロート製薬', '生命還流', '養生と自律の伴走者', 0, '2026-02-28', '地政学ポテンシャル: 自己治癒力を高める再生医療とウェルビーイングの循環', NULL, NULL),
  ('eco-edo-4502', 'theme-seed-edo-circular', '4502', '武田薬品工業', '生命還流', '薬種中買仲間の末裔', 0, '2026-02-28', '地政学ポテンシャル: 近世大阪道修町から続く知恵のグローバル構造化', NULL, NULL),
  ('eco-edo-4894', 'theme-seed-edo-circular', '4894', 'クオリプス', '生命還流', '生命を耕す現代の土壌師', 0, '2026-02-28', '地政学ポテンシャル: iPS細胞による臓器再生という命の還流の物理実装', 'chasm', 'iPS由来心筋シート等は第2相以降の治験・承認・製造キャパがボトルネックの峡谷帯。ニュースフローに Alpha が敏感で、普及曲線の「手前」の高ボラと相関しやすい。'),
  ('eco-edo-4524', 'theme-seed-edo-circular', '4524', '森下仁丹', '生命還流', '伝統知恵のパッケージング師', 0, '2026-02-28', '地政学ポテンシャル: 生薬成分と微小カプセルによる始末の設計', NULL, NULL),
  ('eco-edo-4568', 'theme-seed-edo-circular', '4568', '第一三共', '生命還流', '蘭学から続く知の継承者', 0, '2026-02-28', '地政学ポテンシャル: 日本独自のバイオ技術による生命ネットワークの再構築', NULL, NULL),
  ('eco-edo-4574', 'theme-seed-edo-circular', '4574', '大幸薬品', '生命還流', '置き薬の精神的支柱', 0, '2026-02-28', '地政学ポテンシャル: 家庭の自立的な保健システムを支える歴史的信頼の還流', NULL, NULL),
  ('eco-edo-4523', 'theme-seed-edo-circular', '4523', 'エーザイ', '生命還流', '養生訓の現代的実践者', 0, '2026-02-28', '地政学ポテンシャル: 共感を中心とした生命ネットワークのケア', NULL, NULL),
  ('eco-edo-4880', 'theme-seed-edo-circular', '4880', 'セルソース', '生命還流', '細胞の再資源化拠点', 0, '2026-02-28', '地政学ポテンシャル: 個人の細胞を未来の資源として還流させるインフラ', NULL, NULL),
  ('eco-edo-4536', 'theme-seed-edo-circular', '4536', '参天製薬', '生命還流', '職人の目を見守る番人', 0, '2026-02-28', '地政学ポテンシャル: 見る文化を支え感性を維持する特化型インフラ', NULL, NULL);