...
import {
  ...
  INVENTORY_OVERVIEW_HIDDEN_PRESET,
...
export function InventoryTableColumnToolbar({
  ...
  const overviewTargetHidden = useMemo(
    () =>
      togglableIds.filter((id) => INVENTORY_OVERVIEW_HIDDEN_PRESET.includes(id)),
    [togglableIds],
  );
