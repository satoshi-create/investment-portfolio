...
import { AlertTriangle, ArrowUp, Eye, FileSpreadsheet, NotebookPen, Search, Star, X } from "lucide-react";
...
function JudgmentBadge({ status, reason }: { status: JudgmentStatus; reason: string }) {
  const cfg: Record<
    JudgmentStatus,
